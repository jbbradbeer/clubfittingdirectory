  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        {guide.pillar && (
          <span className="px-2 py-1 text-[0.6rem] font-semibold uppercase tracking-[0.12em] rounded-[3px] bg-[var(--color-gold)] text-[var(--color-forest-deep)]">
            Complete Guide
          </span>
        )}
      </div>
      ...
      <div className="mt-auto pt-5 flex items-center justify-between">
        <span className="inline-flex items-center gap-1.5 text-xs text-[var(--color-charcoal-light)]">
          ...
          <span className="data">{guide.readMinutes}</span> min read
        </span>
