...
export const metadata: Metadata = {
  title: "Admin — Fitting Requests",
  robots: { index: false, follow: false },
}

// Always render fresh (never cache the leads queue)
    ...
    <section className="bg-[var(--color-ivory)] min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-2">
          <h1 className="font-display text-3xl text-[var(--color-charcoal)]">Fitting Requests</h1>
          <form action={logout}>
        ...
        <nav className="flex gap-4 mb-8 text-sm">
          <Link href="/admin" className="text-[var(--color-charcoal-light)] hover:text-[var(--color-forest)]">
            Submissions
          </Link>
          <span className="font-semibold text-[var(--color-forest)]">Fitting Requests</span>
        </nav>
