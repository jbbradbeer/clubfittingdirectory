  ...
  return (
    <section className="relative flex flex-col items-center justify-center overflow-hidden bg-[var(--color-green-deep)] px-4 sm:px-6 py-24 sm:py-32">
      <div className="relative z-10 max-w-3xl mx-auto text-center space-y-8">
        ...
        {/* Search bar — submits to /directory?q=... */}
        <form action="/directory" method="GET" className="max-w-lg mx-auto w-full">
          <div className="flex items-center gap-3 w-full bg-white/10 border border-white/20 rounded-md px-5 py-4 hover:bg-white/15 transition-colors focus-within:border-white/40">
            <svg
            ...
            <input
              ...
              className="flex-1 bg-transparent text-white text-sm font-[family-name:var(--font-body)] placeholder:text-gray-400 focus:outline-none"
