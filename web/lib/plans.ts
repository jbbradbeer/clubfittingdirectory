...
export const SERVICE_TIERS = [
  ...
  },
  {
    ...
    tagline: "The site plus an AI front desk that answers golfers and books fittings.",
    bullets: [
      "Everything in Shop Site",
      "An AI booking assistant on your site — answers fitting questions and captures booking requests 24/7",
      "Review requests after fittings, plus AI-drafted responses to your Google reviews (you approve every one)",
      "Monthly Google Business Profile posts and seasonal offers, written for you",
